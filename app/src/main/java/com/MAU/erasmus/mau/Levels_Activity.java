    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent tothird = new Intent(Levels_Activity.this, Menu_Activity.class);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent togame = new Intent(Levels_Activity.this, Level01.class);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (level2.length()>0){
                    Intent togame = new Intent(Levels_Activity.this, Level02.class);
                    startActivity(togame);
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                }else{
                    Toast.makeText(Levels_Activity.this,"This level is locked",Toast.LENGTH_SHORT).show();
                }
            }
        });
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (level3.length()>0){
                    Intent togame = new Intent(Levels_Activity.this, Level03.class);
                    startActivity(togame);
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                }else{
                    Toast.makeText(Levels_Activity.this,"This level is locked",Toast.LENGTH_SHORT).show();
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (level4.length()>0){
                    Intent togame = new Intent(Levels_Activity.this, Level04.class);
                    startActivity(togame);
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                }else{
                    Toast.makeText(Levels_Activity.this,"This level is locked",Toast.LENGTH_SHORT).show();
