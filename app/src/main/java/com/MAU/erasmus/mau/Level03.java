...
public class Level03 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mp = MediaPlayer.create(Level03.this,R.raw.level3);
        mp.start();
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mp == null)
                {
                    mp = MediaPlayer.create(Level03.this,R.raw.level1);
                    mp.start();
        ...
        btnExit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder alert1 = new AlertDialog.Builder(Level03.this, R.style.AppCompatAlertDialogStyle);
                alert1.setMessage("Do you want to leave game?")
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener(){
                            @Override
                            public void onClick(DialogInterface dialog, int which){
                                Intent tomenu = new Intent(Level03.this,Menu_Activity.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    topic();
                    Intent towin = new Intent(Level03.this,Win_Activity.class);

                    Intent tolose = new Intent(Level03.this,Lose_Activity.class);
                    ...
                    else
                    {
                        ...
                        editor.apply();
                        editor.commit();
                        Toast.makeText(Level03.this, "Level unlocked", Toast.LENGTH_SHORT).show();
                        mp.stop();
                    ...
                    Toast.makeText(Level03.this, "Please check answer(s)", Toast.LENGTH_SHORT).show();
                }
            }
        });
